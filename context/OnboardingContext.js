  ...
  switch (action.type) {
    ...
    case 'SET_USER':
      return { 
        ...
        needsOnboarding: action.payload.needsOnboarding !== undefined ? action.payload.needsOnboarding : state.needsOnboarding,
        error: null 
      };
...
export function OnboardingProvider({ children }) {
  ...
  const value = {
    ...
    updateMultipleFields: (fields) => dispatch({ type: 'UPDATE_MULTIPLE_FIELDS', payload: fields }),
    calculateAge: (dateOfBirth) => dispatch({ type: 'CALCULATE_AGE', payload: dateOfBirth }),
