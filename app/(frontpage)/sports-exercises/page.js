              ...
              <div className="auth-cards goal">
                ...
                <div className="food-list">
                  <div className="food-card ">
                    ...
                    <div className="food-bx">
                      <input type="checkbox" id="swimming" className="d-none" />
                    ...
                    <div className="food-bx">
                      <input type="checkbox" id="trainer" className="d-none" />
                    ...
                    <div className="food-bx">
                      <input type="checkbox" id="jacks" className="d-none" />
                      <label htmlFor="jacks">
                        Jumping Jacks
                        <button type="button">
                          <img alt="Remove" src="/images/close.svg" />
                    ...
                    <div className="food-bx">
                      <input type="checkbox" id="master" className="d-none" />
